...
is $css-dom.props.keys.sort.join(','), '/html/body/div,/html/body/h2[1],/html/body/h2[2]';
...
is $css-dom.style('/html/body/h2[2]'), 'direction:rtl; display:table; font-size:12pt; font-weight:bolder; margin-bottom:0.75em; margin-top:0.75em; unicode-bidi:embed;';
